...
*   **Left Foot ($L$ - Standard Orientation):**
    *   $L:aY < 0.0\,g \longrightarrow \text{BACKWARD}$ (`⬅️ BACKWARD`)
    *   $L:aY \ge 0.0\,g \longrightarrow \text{FORWARD}$ (`➡️ FORWARD`)
*   **Right Foot ($R$ - $180^\circ$ Inverted Mounting):**
    *   $R:aY < 0.0\,g \longrightarrow \text{BACKWARD}$ (`⬅️ BACKWARD`)
    *   $R:aY \ge 0.0\,g \longrightarrow \text{FORWARD}$ (`➡️ FORWARD`)
...
| :---: | :---: | :--- |
| **$18\% \text{ to } 38\%$** | `OPTIMAL ROLL` | Ideal grounded roll-off phase for walks and extensions. |
