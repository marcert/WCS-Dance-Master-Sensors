...
| **M5Stack Mounts for shoes** | 2 | Securely fastens the Foot IMU units to the top of the dance shoes | [3D print shoe mount](Attachments/M5-shoe-mount.stl) |
| **Housing for the scale** | 1 | housing for the load cell and mounting for the M5 | [3D print scale](Attachments/Scale-box.stl) |
